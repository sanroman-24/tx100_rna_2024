...
l_exhaustion <- list(braun_exhaustion = braun_exhaustion, annelaure_exhaustion = annelaure_exhaustion)

# concat to run everything together with gsva function.
allSign <- c(msigdbr_H, motzer_et_al, mc_dermott_et_al, javelin, comparz, cin70, l_exhaustion)
